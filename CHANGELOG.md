...
- 1fcd450: Allow autoloading of modules with no config files
- 39b9d93: Allow case insensitive method calls in ExtensibleClassReflectionExtension
...
- 39f59c9: Add stub for SiteTree
- 3117f3d: Update stub files
