...
final class ConfigurationResolverTest extends PHPStanTestCase
{
    ...
    {
        yield ['Foo', 'Cambis\Silverstan\Tests\Type\Source\Model\Foo'];
        yield ['FooField', 'Cambis\Silverstan\Tests\Extension\Reflection\Source\ORM\FieldType\DBField\FooField'];
